<template functional>
  <span class="mdi mdi-account-multiple-plus-outline" :role="props.role" :aria-label="props.ariaLabel">
    <svg
      fill="currentColor"
      :width="props.width"
      :height="props.height"
